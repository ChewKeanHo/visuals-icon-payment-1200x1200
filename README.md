# Payment Icon 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

Since we need a way to link payment related pages and terminals, we have to
design a new icon for it.

This project houses the development and product of the payment icon for
1200x1200 size.
...
```
--------------------------------------------------------------------------------
Title: Payment Icon 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-icons-payment-1200x1200
UUID: 562B7927-2950-4121-927E-A8DC990A064F
License: Creative Common Attribution 4.0 International License
Made On: 2026-01-12
Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-icons-payment-1200x1200
--------------------------------------------------------------------------------
```
...
> compositions directly for producing a new creation without any monetary
